 ...
 * tool-calling router all go through Qwen2.5-Coder-3B, served by the
 ...
 * "model key" left (QWEN25_CODER_3B) purely so toolOrchestrator.js,
 ...
 * ever runs the one model it was started with.
 */
